                                ...
                                <form class="" method="POST"  name="upform" enctype="multipart/form-data" action="<?php echo $this->config->item('base_url') . 'users/update_user'; ?>">
                                    ...
                                    <div class="form-group row text-center m-10">
                                        <div class="col-md-12 text-center">
                                            ...
                                            <a href="<?php echo $this->config->item('base_url') . 'users/' ?>" class="btn btn-inverse btn-sm waves-effect btn-round waves-light m-b-10"><span class="glyphicon"></span> Back </a>
                                        </div>
                                    </div>
                                    <?php
                                }
