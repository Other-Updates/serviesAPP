...
<div class="mainpanel">
                   ...
                   <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline tablecolor">
                    <tr>
                      <td>TO,
     				  ...
     				  <td class="action-btn-align"> <img src="<?= $theme_path; ?>/images/logo-login.png" alt="Chain Logo" width="100px" height="61px"></td>
  					</tr>
 				    <tr>
     				  <td>PO NO:<?php echo $val['po_no'];?> </td>
    				  <td>Supplier Name:<?php echo $val['name'];?></td>
  				    </tr>
 				    <tr>
   					  <td>Supplier Mobile No: <?php echo $val['mobil_number'];?></td>
    				  <td>Supplier Email ID:<?php echo $val['email_id'];?></td>
  					</tr>
  					<tr>
   					  <td>Tin No:<?=$company_details[0]['tin_no']?></td>
  					 <td></td>
                   </tr>            
                </table>
                         ...
                         if(isset($po_details) && !empty($po_details))
			{
                ...
                <table style="width:50%;" class="table table-striped tablecolor">
                	<tr>
                    	...
                    	<td  style="width:49%;">
                        	<table style="width:100%;">
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td class="viewquotation"><?php echo $val['mode_of_payment'];?></td>
                                </tr>
