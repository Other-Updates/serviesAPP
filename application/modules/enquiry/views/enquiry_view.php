        ...
        <div class="table-responsive" id='result_div'>
            ...
            <div class="row text-center m-10">
                <div class="col-sm-12 invoice-btn-group text-center">
                    ...
                    <a href="<?php echo $this->config->item('base_url') . 'enquiry/enquiry_list/' ?>" class="btn btn-inverse btn-sm waves-effect waves-light m-b-10"><span class="glyphicon"></span> Back </a>
                </div>
            </div>
        </div>
    </div>
