                        ...
                        <form  action="<?php echo $this->config->item('base_url'); ?>service/" method="post" >
                            ...
                            <table  class="table table-striped responsive table-bordered dataTable no-footer dtr-inline">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">GSTIN No: <?= $company_details[0]['tin_no'] ?>  </td>
                                    ...
                                    if (isset($quotation_details) && !empty($quotation_details)) {
                                        foreach ($quotation_details as $vals) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="hsn_td">
                                                    <input type="text"  name="hsn_sac[]" id="hsn_sac" value="<?php echo $vals['hsn_sac']; ?>" class='form-control hsn_sac' readonly="" tabindex="-1"/>
                                                </td>
                                                <td class="add_amount_td">
                                                    <input type="text"  name="add_amount[]" id="add_amount" value="<?php echo $vals['add_amount']; ?>" class='form-control add_amount right-align' readonly="" tabindex="-1"/>
                                                </td>
                                                <?php
...
//        $('.final_amt').val((final_sub_total + Number($('.totaltax').val())).toFixed(2));
            ...
            $('.qty').each(function () {
                var qty = $(this);
                var percost = $(this).closest('tr').find('.percost');
                var add_amount = $(this).closest('tr').find('.add_amount');
                var subtotal = $(this).closest('tr').find('.subtotal');
                total_item = 0;
                $('.totaltax').each(function () {
                    var totaltax = $(this);
                ...
                if (Number(qty.val()) != 0)
                {
                    sub_total = (Number(qty.val()) * (Number(percost.val()) + Number(add_amount.val())));
                    subtotal.val(sub_total.toFixed(2));
                    final_qty = final_qty + Number(qty.val());
                    final_sub_total = final_sub_total + sub_total;
                }
