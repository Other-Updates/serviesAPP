                                                                                 ...
                                                                                 if (!empty($service_history)) {
                                                                                    foreach ($service_history as $history) {
                                                                                        ...
                                                                                        <div class="col-lg-2 col-sm-6">
                                                                                            <div class="thumbnail">
                                                                                                <div class="thumb">
                                                                                                    <a href="#" data-lightbox="1" title="<?php echo $history['description'];?>">
                                                                                                        <img src="<?php echo $history['emp_image_upload']; ?>" alt="" class="img-fluid img-thumbnail">
                                                                                                    </a>
                                                                                                </div>
                                                                                                <span title="Work Performed"><?php echo $history['work_performed'];?></span>
                                                                                            </div>
                                                                                        </div>
                                                                                        <?php
                                                                                    }
