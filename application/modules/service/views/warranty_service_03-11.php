    ...
    <div class="contentpanel mb-25">
        <div class="media">
            ...
            <tr>
                ...
                <td colspan="4" style="text-align:right;font-weight:bold;"><input type="text" name="item_name[]" class="tax_label text_right" style="width:100%;" ></td>
                <td>
        ...
        <table class="static" style="display: none;">
            <tr>
                ...
                <td >
                    <select name='brand[]' class="brand"  tabindex="1">
                        <option value="">Select</option>
                        <?php
        ...
        <table class="static_ser" style="display: none;">
            <tr>
                ...
                <td >
                    <select name='brand[]'  tabindex="1" class="brand">
                        <option value="">Select</option>
                        <?php
                        if (isset($brand) && !empty($brand)) {
                            foreach ($brand as $val) {
                ...
                <form  action="<?php echo $this->config->item('base_url'); ?>service/" method="post" class=" panel-body">
                    ...
                    <table  class="table table-striped responsive table-bordered dataTable no-footer dtr-inline">
                        <tr>
                            ...
                            <td class="action-btn-align"> <img src="<?= $theme_path; ?>/images/incredible.png" alt="Chain Logo" width="182px"></td>
                        </tr>
                        <tr>
                            <td class="first_td1"> Invoice NO: <?php echo $val['inv_id'] ?> </td>
                            <td class="first_td1">  Quotation NO:  <?php echo $val['q_no']; ?> </td>
                        </tr>
                        <tr>
                            <td class="first_td1"> Job Id: <?php echo $val['job_id']; ?>
                            ...
                            <td class="first_td">GSTIN No: <?= $company_details[0]['tin_no'] ?>  </td>
                    ...
                    <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline" id="add_quotation">
                            ...
                            if (isset($quotation_details) && !empty($quotation_details)) {
                                foreach ($quotation_details as $vals) {
                                    ...
                                    <tr>
                                        ...
                                        <td > <input type="hidden"  name="brand[]" id="type" class=' tabwid form-align type required brand'  tabindex="1" value="<?php echo $vals['brand']; ?>"  />
                        ...
                        <td colspan="2" style="width:70px; text-align:right;"></td>
                        <td colspan="4" style="text-align:right;font-weight:bold;"><input type="text"  name="quotation[tax_label]" class='tax_label text_right '  tabindex="1"  readonly="readonly"  style="width:100%;" value="<?php echo $val['tax_label']; ?>"/></td>
                        <td>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td><input type="text"  name="quotation[net_total]"  readonly="readonly"  tabindex="1" class="final_amt text_right" style="width:70px;" value="<?php
                                    echo $val['net_total'];
                                    ;
                                    ?>" /></td>
                                <td></td>
