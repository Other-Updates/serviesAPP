            ...
            <div class="card-block">
                ...
                <table class="static" style="display: none;">
                    <tr>
                        ...
                        <td>
                            <input type="text" tabindex="-1"  name='sub_total[]' readonly="readonly" id="sub_total" class="subtotal form-control text-right" />
                        </td>
                ...
                <table class="static_ser" style="display: none;">
                    <tr>
                        ...
                        <td>
                            <input type="hidden" tabindex="-1" name='available_quantity[]'  value="0" readonly="readonly"/>
                            <input type="text"   tabindex="3"  name='quantity[]' class="qty form-control" id="qty" onkeypress="return isNumber(event, this)"/>
                            <input type="hidden" name='old_quantity[]' value="0"/>
                            <span class="error_msg"></span>
                        </td>
                        ...
                        <td>
                            <input type="text" tabindex="-1" name='sub_total[]' readonly="readonly" id="sub_total" class="subtotal text-right form-control" />
                        </td>
                        <td class="action-btn-align"><a id='delete_group' class="del btn btn-danger btn-mini"><span class="fa fa-trash"></span></a></td>
                    </tr>
                </table>
                    ...
                    foreach ($quotation as $val) {
                        ...
                        <form  action="<?php echo $this->config->item('base_url'); ?>service/" method="post" >
                            ...
                            <table  class="table table-striped responsive table-bordered dataTable no-footer dtr-inline">
                                ...
                                <tr>
                                    <td class="text-left"> Project Cost Id: <?php echo $val['job_id']; ?>
                                    ...
                                    <td class="text-left">
                                        <!--                                        GSTIN No: <?php //echo $company_details[0]['tin_no']                                                                   ?>  -->
                                    </td>
                                    ...
                                    if (isset($quotation_details) && !empty($quotation_details)) {
                                        foreach ($quotation_details as $vals) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <textarea  name="product_description[]" id="product_description"    class='form-control auto_customer tabwid product_description ' readonly="readonly" onkeyup='f2(this);'><?php echo $vals['product_description']; ?></textarea>
                                                </td>
                                                <td >
                                                ...
                                                if ($vals['type'] == 'product') {
                                                    if (isset($vals['stock']) && !empty($vals['stock'])) {
                                                        ?>
                                                        <td>
                                                            <input type="text"   tabindex="-1"  name='available_quantity[]' class="code form-control stock_qty" value="<?php echo $vals['stock'][0]['quantity'] ?>" readonly="readonly"/>
                                                            <input type="text"   tabindex="2"  name='quantity[]' class="form-control qty required" value="<?php echo $vals['quantity'] ?>" onkeypress="return isNumber(event, this)"/>
                                                            <span class="error_msg"></span>
                                                        </td>
                                                    <?php } else { ?>
                                        ...
                                        <?php if ($vals['type'] == 'service') {
                                            ...
                                            <td>
                                                ...
                                                <input type="text"   tabindex="2"  name='quantity[]' class="form-control qty" value="<?php echo $vals['quantity'] ?>" onkeypress="return isNumber(event, this)"/>
                                                <span class="error_msg"></span>
                                            </td>
                                        <?php } ?>
                                        <td>
                                        ...
                                        <td style="display:none">
                                            <input type="text"   tabindex="-1"   name='tax[]' class="pertax form-control" value="<?php echo $vals['tax'] ?>"readonly="readonly" />
                                        </td>
                                        <td>
                            ...
                            <div class="form-group row m-10">
                                <div class="col-md-12 text-center">
                                    <button  id="save" class="btn btn-primary btn-sm waves-effect waves-light" tabindex="5">Create</button>
...
//
    ...
    $(document).on('keyup', '.qty,.percost,.pertax,.totaltax', function () {
        calculate_function();
    });
