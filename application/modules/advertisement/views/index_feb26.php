                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="pull-right">
                            <a href="javascript::" style="" title="Active" onclick="$('#projects_action').val('1');   $('#actionform').submit();"><span class="badge badge-success white" id="status_active" style="margin-right:5px;">ACTIVE</span></a>
                            <a href="javascript::" style="" title="Inactive" onclick="$('#projects_action').val('0');$('#actionform').submit();"><span class="badge badge-danger white" id="status_inactive">INACTIVE</span></a>
                        </div>
                    </div>
                                        ...
                                        if (!empty($ads)) {
                                            ...
                                            foreach ($ads as $ads_list) {
                                                ...
                                                <tr class="ads_row<?php echo $ads_list['id'] ?>">
                                                    ...
                                                    <td class="text-center"><span class="  label  <?php echo ($ads_list['status'] == 1) ? 'label-success' : 'label-danger'; ?>"><?php echo ($ads_list['status'] == 1) ? 'Active' : 'Inactive'; ?></span></td>
                                ...
                                <div class="col-md-6">
                                    <div class="material-group">
                                        ...
                                        <div class="form-group form-primary">
                                            <input type="text" name="ads[ads_name]" class="form-control required" id="ads_name"/>
