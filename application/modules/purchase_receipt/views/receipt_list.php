    ...
    <div class="card-block table-border-style">
        <table class="table table-striped table-bordered responsive no-footer dtr-inline search_table_hide" style="display:none;">
            <tr>
                ...
                <td><a style="float:right;" id='search' class="btn btn-inverse btn-sm">Search</a></td>
            </tr>
        </table>
        <div class="table-responsive" id='result_div'>
            <table class="table table-striped table-bordered" id="receipt_table">
                <thead>
                    <tr>
                        ...
                        <td class="text_right">Paid Amt</td>
                        <td class="text_right">Discount Amt</td>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#receipt_table').DataTable({
            ...
            "ajax": {
                url: BASE_URL + "purchase_receipt/ajaxList",
                "type": "POST",
            },
