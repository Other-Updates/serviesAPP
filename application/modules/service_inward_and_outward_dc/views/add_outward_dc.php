            ...
            <div class="card-block">
                <table class="static" style="display: none;">
                    <tr>
                        ...
                        <td>
                            <input type="text" tabindex="-1" name="serial_no[]" id='serial_no'  class='form-control'>
                            <span class="error_msg text-danger"></span>
                        </td>
                        <td>
                ...
                <table class="static_ser" style="display: none;">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="serial_no[]" tabindex="-1" id='serial_no'  class='form-control'>
                            <span class="error_msg text-danger"></span>
                        </td>
                        <td>
                            <textarea  name="product_description[]" tabindex="-1"  id="product_description" class='form-control auto_customer tabwid4 product_description' onkeyup='f2(this);'/>  </textarea>
                        ...
                        <div class="col-md-3">
                            <div class="material-group">
                                ...
                                <div class="form-group form-primary">
                                    <label class="float-label">Outward DC NO</label>
                        ...
                        <div class="col-md-3">
                            <div class="material-group">
                                ...
                                <div class="form-group form-primary">
                                    ...
                                    <input type="hidden"  name="quotation[service_type]" value="outward" id="invoice_id" class=' tabwid form-control' />
                        ...
                        <div class="col-md-3">
                            <div class="material-group">
                                ...
                                <div class="form-group form-primary">
                                    ...
                                    <input tabindex="2" id="dropper-default" name="quotation[created_date]" data-date="" data-month="" data-year="" value="<?php echo date('d-M-Y'); ?>" class="form-control required dropper-default" type="text" placeholder="" />
                                    <span class="form-bar"></span>
                                    <span class="error_msg text-danger"></span>
                        ...
                        <div class="col-md-3">
                            <div class="material-group">
                                ...
                                <div class="form-group form-primary">
                                    ...
                                    <input name="quotation[project]"  type="text" class="form-control project_name required"  tabindex="3" />
                                    <span class="form-bar"></span>
                                    <span class="error_msg text-danger"></span>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered" id="add_quotation" >
                                ...
                                <tbody id='app_table'>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="serial_no[]" id='serial_no' tabindex="-1" class='form-control required'>
                                            <span class="error_msg text-danger"></span>
                                        </td>
                                        <td>
                                            <textarea  name="product_description[]" tabindex="-1"  id="product_description" class='form-control auto_customer tabwid4 product_description' onkeyup='f2(this);'/> </textarea>
                                ...
                                <div class="col-md-4">
                                    <div class="material-group">
                                        ...
                                        <div class="form-group form-primary">
                                            ...
                                            <input type="text" class="form-control class_req terms" tabindex="8" name="quotation[delivery]"  onkeyup='f2(this);'/>
                                            <span class="form-bar"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="material-group">
                                        ...
                                        <div class="form-group form-primary">
                                            ...
                                            <input type="text" class="form-control class_req terms" tabindex="9" name="quotation[warranty]"  onkeyup='f2(this);'/>

                                            <input type="hidden"  name="quotation[supplier]" id="c_id" class="id_customer" />
