    ...
    foreach ($quotation as $val) {
        ...
        <table border="1" row-style="page-break-inside:avoid;">
            <tr >
                ...
                <td colspan="2" align="center" width="325"> <img src="<?= $this->config->item("base_url") ?>themes/incsol/assets/images/printlogo.png" alt="Chain Logo" style="margin-top: 5px"></td>
            </tr>
            <tr>
                <td align="left" width="208"><span class="pdf-f">Invoice NO : </span><?php echo $val['inv_id']; ?></td>
                <td colspan="2" align="left" width="325" colspan="2"><span class="pdf-f">Quotation NO : </span><?php echo $val['q_no']; ?></td>
            </tr>
            <tr>
                <td align="left" width="208" ><span class="pdf-f"></span> </td>
                <td colspan="2"align="left" width="325" colspan="2"><span class="pdf-f">Date: </span> <?= ($val['created_date'] != '1970-01-01') ? date('d-M-Y', strtotime($val['created_date'])) : ''; ?></td>
        ...
        <table border="1" style="padding: 5px 5px;" row-style="page-break-inside:avoid;">
            ...
            <tr>
                <?php if ($val['is_gst'] == 1) { ?>
                    <td colspan="8" align="center"><b>COMERCIAL INVOICE</b></td>
                <?php } else { ?>
                    <td colspan="6" align="center"><b>COMERCIAL INVOICE</b></td>
                <?php } ?>
            </tr>
            <tr>
                <?php if ($val['is_gst'] == 1) { ?>
