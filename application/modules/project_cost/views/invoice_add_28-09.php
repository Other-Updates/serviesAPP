            ...
            <div class="contentpanel mb-25">
             <div class="media">
              <h4>Add Invoice</h4>
                ...
                <tr>
                            <td>
                            	<select  class='cat_id static_style class_req' name='categoty[]' tabindex="1">
...
<!--                            <td class="sub_category">
                 ...
                 <?php       if(isset($quotation) && !empty($quotation))
			{
                ...
                <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline">
                   ...
                   <tr>
                        <td class="first_td1"><span  class="tdhead">Invoice NO:</span> <?php echo $last_id[0]['value'];?> <input type="hidden"  tabindex="-1" name="quotation[inv_id]" class="code form-control colournamedup tabwid form-align" value="<?php echo $last_id[0]['value'];?>"  id="grn_no"></td>
                        <td class="first_td1"><span  class="tdhead">Reference NO:</span>  <?php echo $val['q_no'];?></td>
                   </tr> 
                   <tr>
                       <td>
                            <span  class="tdhead"> Customer Po:</span> <input type="text" tabindex="1" name="quotation[customer_po]" class="form-control required" style="width:200px; display: inline"/>
                            <span class="error_msg"></span>
                       </td> 
                   ...
                   <tr>
                       <td  class="first_td1"><span  class="tdhead">Warranty :</span>
                            <input type="text"   name="quotation[warranty_from]" tabindex="1" class="form-control datepicker class_req required" placeholder="dd-mm-yyyy" style="width:200px; display: inline">
                       ...
                       <td>
                           ...
                           <input type="text" tabindex="1"  class="form-control  datepicker " name="quotation[created_date]" placeholder="dd-mm-yyyy" style="width:200px; display: inline"/>
                        </td>
                   </tr>
                </table>
                ...
                <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline" id="add_quotation">
                    ...
                    <tr>
                        ...
                        <td  width="2%" class="first_td1 action-btn-align">Tax</td>
