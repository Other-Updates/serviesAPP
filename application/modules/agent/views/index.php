        ...
        <div class="panel-body">
            <div class="tabs">
                ...
                <ul class="list-inline tabs-nav tabsize-17" role="tablist">
                    ...
                    <li role="presentation" class=""><a href="<?php if ($this->user_auth->is_action_allowed('masters', 'agent', 'add')): ?>#field-agent<?php endif ?>" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="false" class="<?php if (!$this->user_auth->is_action_allowed('masters', 'agent', 'add')): ?>alerts<?php endif ?>">Add Field Agent</a></li>
                </ul>
...
<!--                                        <span id="duplica" class="val"  style="color:#F00; font-style:oblique;"></span>-->
                            ...
                            <div class="frameset_table action-btn-align">
                                <table>
                                    ...
                                    <td>&nbsp;</td>
                                    <td><input type="reset" value="Clear" class=" btn btn-danger" id="reset" /></td>   <td>&nbsp;</td>
                                    <td><a href="<?php echo $this->config->item('base_url') . 'agent/' ?>" class="btn btn-defaultback1"><span class="glyphicon"></span> Back </a></td>
                                </table>
                            </div>
                        </form>
                    </div>
                    <div role="tabpanel" class="tab-pane active tablelist" id="field-agent-details">
                        ...
                        <!--                        <td><?= $val['address1'] ?></td>
                                                ...
                                                <td class="action-btn-align">
                                                    <a href="<?php if ($this->user_auth->is_action_allowed('masters', 'agent', 'edit')): ?><?= $this->config->item('base_url') . 'agent/edit_agent/' . $val['id'] ?><?php endif ?>" class="tooltips btn btn-info btn-xs <?php if (!$this->user_auth->is_action_allowed('masters', 'agent', 'add')): ?>alerts<?php endif ?>" title="Edit">
                                                        <span class="fa fa-edit"></span></a>&nbsp;&nbsp;
                                                    <a href="<?php if ($this->user_auth->is_action_allowed('masters', 'agent', 'delete')): ?>#test3_<?php echo $val['id']; ?><?php endif ?>" data-toggle="modal" name="delete" class="tooltips btn btn-danger btn-xs <?php if (!$this->user_auth->is_action_allowed('masters', 'agent', 'add')): ?>alerts<?php endif ?>" title="In-Active">
